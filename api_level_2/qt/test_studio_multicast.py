...
from demo_filterchains import MulticastFilterchain
...
class MyConfigDialog(ConfigDialog):
  ...
  def extra(self): # let's add some text to the config dialog..
    self.notice=QtWidgets.QLabel("The first stream is multicasted to mcast_start_port, the second stream to mcast_start_port+4, etc.\n The multicast address is "+mcast_address+"\n",self)
