...
class ValkkaFSConfigMany:
    ...
    def __init__(self, parent=None,\
            blocksize = 1, # MB
            n_blocks = 100,
            blocksize_limits=(1, 1024*100), n_blocks_limits=(4, 999999)):  # 1 MB -> 100 GB, -> 100 TB
        ...
        self.label1 = QLabel("Filesystem Specs. \nThere will be identical ValkkaFS per each stream", self.main_widget)
        ...
        self.format_checkbox = QCheckBox("FORMAT", self.main_widget)
        self.format_checkbox.setChecked(True)
        self.format_label = QLabel(
            "Applies filesystem changes (clears ValkkaFS) before streaming starts")
        ...
        self.main_lay.addWidget(self.format_checkbox, 9, 0)
    ...
    def initValues(self):
        ...
        self.blocksize = round(self.fs.blocksize / 1024 /
    ...
    def regular_file_slot(self):
        self.regular_file = QFileDialog.getOpenFileName(
            self.main_widget, self.regular_file, filter="*.vfs")[0]
    """
    ...
    def getValkkaFSPars(self):
        return self.blocksize, self.n_blocks,self.format_checkbox.checkState() == Qt.CheckState.Checked
...
class MyGui(QMainWindow):
    ...
    def setupUi(self):
        ...
        self.fspars = ValkkaFSConfigMany(parent=self.w)

    def closeEvent(self, e):
        print(">", self.fspars.getValkkaFSPars())
