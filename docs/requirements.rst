...
1. The pre-built library and its python-bindings for **Ubuntu 16.04 LTS**, **x86_64** and **python 3.5** are available at the python package index (PyPI) and can be installed with:
