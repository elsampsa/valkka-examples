...
class MyProcess(RGB24Process):
    ...
    # so don't be surprised if there is only one processor screaming 100% in your system
...
# NOTE: multiprocesses are started before anything else
...
# had here gradually more cameras and observe when things go belly up
cams = {
